...
class ReutilizarActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_reutilizar)
    ...
    private fun initUI() {
        ...
        val btnContinuard = findViewById<Button>(R.id.btnContinuard)
        btnContinuard.setOnClickListener {
